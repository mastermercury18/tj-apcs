...
public class StringMethods
{
   public static void main(String[] args)
   {
      ...
      for(String str : abra2)
         System.out.print(str+" ");                   //
      System.out.println();
      String[] words = "A B R A C A D A B R A".split(" ");
      ...
      */
      ...
      String[] date = "09/16/2008".split("/");
      int counter = 0;
      for(String str : date){
         my_array[counter] = str;
         counter ++;
      }
      String month = my_array[0];
      String day = my_array[1];
      String year = my_array[2];
      ...
      */      
      ...
      for (int i=0; i<str.length(); i++){
         ...
         if (punct.indexOf(str.substring(i,i+1)) != -1){
      ...
      */      
      ...
      for (int i=0; i<str2.length(); i++){
         //System.out.println(str.charAt(i));
         if (letters.indexOf(str2.substring(i,i+1)) == -1){
            str2 = str2.replace(Character.toString(str2.charAt(i)), "");
            i--;
         }
      }
