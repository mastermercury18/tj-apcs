...
public class MergeSort_Driver
{
   ...
   {
      //Part 1, for doubles
      //double[] array = {3,1,4,1,5,9,2,6};
      double[] array = {21, 1, 26, 45, 29, 28, 2, 9, 16, 49, 39, 27, 43, 34, 46, 40};
   ...
   */
   ...
   {  
      ...
      if (low < high)
      {
         ...
         System.out.println("low is: " + low + " middle is: " + middle + " high is: " + high);
      ...
      for (int i=low; i<=high; i++){
        /* if (i1 == i2){
         ...
         if (array[i2] < array[i1]){
            copyBuffer[i] = array[i2];
            i2 ++;
            //copyBuffer[high] = array[i2];
         }
         else {
            copyBuffer[i] = array[i1];
            i1 ++;
            //copyBuffer[high] = array[i1];
         }
     }
